...
{
	/// <summary>This component allows you to generate the <b>SgtRing.LightingTex</b> field.</summary>
	[ExecuteInEditMode]
	...
	public class SgtRingLightingTex : MonoBehaviour
	{
		...
		public float BackStrength { set { if (backStrength != value) { backStrength = value; DirtyTexture(); } } get { return backStrength; } } [SerializeField] [Range(0.0f, 1.0f)] private float backStrength = 0.5f;

		/// <summary>The of the perpendicular scattered light.</summary>
		public float BaseStrength { set { if (baseStrength != value) { baseStrength = value; DirtyTexture(); } } get { return baseStrength; } } [SerializeField] [Range(0.0f, 1.0f)] private float baseStrength = 0.2f;
		...
		{
			var importer = CwHelper.ExportTextureDialog(generatedTexture, "Ring LightingTex");
...
namespace SpaceGraphicsToolkit.Ring
{
	...
	public class SgtRingLightingTex_Editor : CwEditor
	{
